                    ...
                    <div class="card-body">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <form action="<?= base_url; ?>/datapendaftaran/carisiswa" method="POST">
                                        <div class="input-group mb-3 mt-2">
                                            ...
                                            <a href="<?= base_url; ?>/datapendaftaran"><button class="btn btn-outline-secondary" type="button">Reset</button></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                        ...
                                        foreach ($data['datasiswa_all'] as $siswa) : ?>
                                            <form action="<?= base_url; ?>/datapendaftaran/deletesiswa" method="POST">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        $newDate = date("d-m-Y", strtotime($siswa['reg_date']));
                                                        echo $newDate;
                                                        ?></td>
                                                    <td>
                                                        <?php
...
<!-- Modal Tambah siswa -->
<div class="modal fade" id="aktifasiakun" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Siswa</h5>
