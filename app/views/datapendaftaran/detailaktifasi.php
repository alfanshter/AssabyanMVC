                    ...
                    <div class="card-body">
                        <div class="container">
                            <div class="container">
                                ...
                                <form action="<?= base_url; ?>/datapendaftaran/aktifasisiswa" method="POST">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <center><img src="<?= base_url; ?>/img/<?= $data['detailsiswa']['foto']; ?>" alt="" style="height: 200px; width :200px" id="foto"><br>
                                            ...
                                            <div class="form-group">
                                                <!-- <a href="<?= base_url; ?>/datapendaftaran/ProsesEditFoto/<?= $data['detailsiswa']['id_siswa']; ?>/" id="btn_save" name="btn_save" type="submit" class="btn btn-success">Edit Foto</a> -->
                                    ...
                                    <center>
                                        <button type="submit" onclick="return confirm('Terima Pendaftaran?')" class="btn btn-success">
                                            Aktifasi
                                        </button>
